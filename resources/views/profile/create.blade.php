<x-master title='Create Profile'>
   ...
   @endif
   <form class="w-50 container" method="POST" action="{{route('store')}}" enctype="multipart/form-data">
    <!-- Name input -->
    @csrf
    ...
    <!-- Email input -->
    <div class="form-outline mb-4">
      <input type="email" id="form4Example2" class="form-control" name='email' value="{{old('email')}}"/>
  ...
  <div class="form-outline mb-4">
    ...
    <!-- Message input -->
    <div class="form-outline mb-4">
      <textarea class="form-control" id="form4Example3" rows="4" name='bio' >{{old('bio')}}</textarea>
